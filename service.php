...
<section id="product-design" class="snt-services-page-section">
  <div class="row">
		...
		<div class="col-md-4"style="border:none; background:none;">
		  <div class="row">
			<div class="col-12">
			  ...
			  <h1 class="product-h1">Product Design </h1>
			</div>
		  </div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-8" id="ux" style="display:none;">
			<div class="col-md-12">
				<h2>UX/UI DESIGN</h2>
		...
		<div class="col-md-8" id="interaction" style="display:none;">
			<div class="col-md-12">
...
<section id="product-development" class="snt-services-page-section">
  	<div class="row">
	<div class="col-md-10 col-md-offset-1">
		...
		<div class="col-md-4"style="border:none; background:none;">
		  <div class="row">
			<div class="col-12">
			  ...
			  <h1 class="product-h1">Product Development </h1>
			</div>
		  </div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-8"  id="prototype" style="display:none;">
			<div class="col-md-12">
				<h2>PROTOTYPE</h2>
		...
		<div class="col-md-8"  id="minimum" style="display:none;">
			<div class="col-md-12">
...
<section id="consulting" class="snt-services-page-section">
  	<div class="row">
	<div class="col-md-10 col-md-offset-1">
	...
	<div class="row consulting-display">
		...
		<div class="col-md-8" id="software">
			<div class="col-md-12">
		...
		<div class="col-md-8" id="product-d" style="display:none;">
			<div class="col-md-12">
		...
		<div class="col-md-8" id="social" style="display:none;">
			<div class="col-md-12">
		...
		<div class="col-md-8" id="interim" style="display:none;">
			<div class="col-md-12">
...
<section class="text-center snt-services-page-section">
  <img class="service-page-photo">
...
<section id="service-travel" class="snt-services-page-section">
	<div class="row">
	<div class="col-md-10 col-md-offset-1">
	  
	  <div class="row service-travel-photo">
	  
		<div id=travel class="col-md-4"style="border:none; background: none !important;">
		  <div class="row">
			<div class="col-12">
			  <h3 class="yellow">WHAT WE ARE REALLY GOOD AT</h3>
			  <h1 class="travel-h1">Travel Technology </h1>
			  ...
			  <div class="col-12">
				...
				<p class="travel-p"> They were used for a variety of different scenarios in applications from booking a bed or berth to a flight or an apartment.</p>
...
function showProductDesign() {
  var x = document.getElementById("product-d");
...
function showInterim() {
  var x = document.getElementById("interim");
  var y = document.getElementById("product-d");
  var z = document.getElementById("software");
