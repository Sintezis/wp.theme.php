...
<section id="blog" class="snt-blog-section">
	...
	<?php if (count($posts) > 1) : ?>
		...
		<div class="col-xs-12 col-sm-12 col-md-6">
			<button class="snt-blog-header-lg" onclick="window.location.href='<?php echo esc_url(get_post_permalink($posts[0])) ?>'">
				<h0 href="<?php echo esc_url(get_post_permalink($posts[0])) ?>"><?php echo apply_filters( 'the_title', $posts[0]->post_title);?></h0>
		...
		<div class="col-xs-12 col-sm-12 col-md-6" placeholder="failure" style="margin-bottom:80px;">
				<button class="snt-blog-header-md snt-blog-header-ph-2" style="margin-top: 0.1rem;" onclick="window.location.href='<?php echo esc_url(get_post_permalink($posts[1])) ?>'">
					<h0 href="<?php echo esc_url(get_post_permalink($posts[1])) ?>"><?php echo apply_filters( 'the_title', $posts[1]->post_title);?></h0>
