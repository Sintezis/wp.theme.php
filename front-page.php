      ...
      <div class="col-md-12">
        ...
        <div class="welcome-col-md-4 col-md-4 col-sm-4">
			  <button class="welcome-services-button" onclick="window.location.href='/services/#product-design'">
				<img src="<?php echo get_template_directory_uri().'/imgs/designsprint_desktop.png'?>" class="center-block" alt="">
          ...
          <div class="welcome-col-md-4 col-md-4 col-sm-4">
		 	 <button class="welcome-services-button" onclick="window.location.href='/services/#product-development'">
				<img src="<?php echo get_template_directory_uri().'/imgs/productdev_desktop.png'?>" class="center-block" alt="">
          ...
          <div class="welcome-col-md-4 col-md-4 col-sm-4">
			<button class="welcome-services-button" onclick="window.location.href='/services/#consulting'">
				<img src="<?php echo get_template_directory_uri().'/imgs/consulting_desktop.png'?>" class="center-block" alt="">
				<h0>Consulting</h0>
